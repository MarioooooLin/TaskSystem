$(document).ready(function () {
    ...
    function syncActionBar() {
        ...
        var collapsed =
            $(".sidebar").hasClass("sidebar--collapsed") || $(".content-wrapper").hasClass("content-wrapper--expanded");
    ...
    $(document).on("click", ".sidebar-group__header", function () {
        ...
        // 收合其他已展開的群組
        $(".sidebar-group").not($group).removeClass("open").find(".sidebar-group__body").slideUp(200);
    ...
    if ($("#orderBody").length) {
        ...
        $("#clearBtn").on("click", function () {
            ...
            $("#filterDateRange").val("");
            $("#orderBody tr").show();
            $("#abnormalCount").text($('#orderBody tr[data-status="abnormal"]').length);
        });
    ...
    if ($("#txnBody").length) {
        function applyTxnFilter() {
            ...
            $("#txnBody tr").each(function () {
                ...
                var matchKw =
                    !keyword || rowKw.indexOf(keyword) !== -1 || $tr.text().toLowerCase().indexOf(keyword) !== -1;
    ...
    if ($("#ciContactList").length) {
        ...
        function syncCiActionBar() {
            ...
            var sw = getComputedStyle(document.documentElement).getPropertyValue("--sidebar-width").trim();
    ...
    if ($("#pmTableBody").length) {
        ...
        function applyPmFilter() {
            ...
            $(".pm-pagination-info").text("顯示第 1 至 " + count + " 名成員，共 " + count + " 名成員");
        }
