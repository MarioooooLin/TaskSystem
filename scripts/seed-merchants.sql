...
VALUES (2, N'王小美', N'owner@mountainsea.com.tw', NULL, 1),
...
SELECT @u1 = Id
FROM Users
WHERE Email = 'owner@mountainsea.com.tw';
SELECT @u2 = Id
FROM Users
WHERE Email = 'owner@taipeihotel.com.tw';
SELECT @u3 = Id
FROM Users
WHERE Email = 'owner@hualien-bb.com.tw';
SELECT @u4 = Id
FROM Users
WHERE Email = 'owner@tainan-old.com.tw';
SELECT @u5 = Id
FROM Users
...
VALUES (
        @u1,
        N'山海旅宿股份有限公司',
        N'Mountain Sea Stay Co.',
        N'12345678',
        N'旅宿',
        N'王小美',
        N'02-2720-8889',
        NULL,
        N'service@mountainsea.com.tw',
        N'https://www.mountainsea.com.tw',
        N'台北市信義區信義路五段7號',
        '2018-05-20',
        2,
        GETUTCDATE()
    ...
    (
        @u2,
        N'台北精品旅館有限公司',
        N'Taipei Boutique Hotel Ltd.',
        N'23456789',
        N'旅宿',
        N'陳大明',
        N'02-2345-6789',
        N'02-2345-6790',
        N'info@taipeihotel.com.tw',
        NULL,
        N'台北市大安區忠孝東路四段100號',
        '2015-03-10',
        2,
    ...
    (
        @u5,
        N'墾丁海景渡假村有限公司',
        N'Kenting Ocean View Resort',
        N'56789012',
        N'旅宿',
        N'張美惠',
        N'08-888-9999',
        NULL,
        N'resort@kenting.com.tw',
        N'https://www.kenting-resort.com.tw',
        N'屏東縣恆春鎮墾丁路100號',
        '2016-07-04',
        4,
        GETUTCDATE()
...
VALUES (@m1, 50000.00, 12000.00, 200000.00),
